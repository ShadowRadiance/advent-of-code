 ...
 * button presses.
 * However, the fewest button presses required is 2. One way to do this is
 ...
 * machine's joltage level counters to match the specified joltage requirements.
 *
